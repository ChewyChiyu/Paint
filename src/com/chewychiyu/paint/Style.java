...
public class Style {
    ...
    public static TitledBorder tool_changer_title = new TitledBorder(bevel_line_border,"Tools",TitledBorder.CENTER,TitledBorder.TOP);
	...
	public static Dimension tool_changer_dim = new Dimension(tool_bar_dim.width/12,(int)(tool_bar_dim.height*.60));
